      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 sm:p-8">
        <div className="w-full max-w-md">
          <div className="lg:hidden text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Join us and start collaborating</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <button
              ...
              className="w-full bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-400 text-white font-semibold py-2.5 rounded-lg transition duration-200 flex items-center justify-center space-x-2 mt-6"
            >
              {isSubmitting ? (
                <>
                  <svg
